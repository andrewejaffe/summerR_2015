...
This plot shows the cafe wall illusion (see [Wikipedia](https://en.wikipedia.org/wiki/Caf%C3%A9_wall_illusion)) where my brain struggles to see all the lines as parallel.


## Simple illusion

```{r 'simple illusion', echo = FALSE}
...
```{r 'parallel expanded', echo = FALSE}
x = 1:1000 / 10
y = 1/log10(x)
y2 = y + 0.2
...
Based on the [illusions knitrBootstrap vignette](http://cran.r-project.org/web/packages/knitrBootstrap/vignettes/illusions.html) which itself is based on ´[Kohske Takahashi](https://twitter.com/kohske) code at http://rpubs.com/kohske/R-de-illusion.
