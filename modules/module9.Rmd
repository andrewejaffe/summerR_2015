...
```{r seed, comment="",echo=FALSE,prompt=TRUE,results='hide' }
set.seed(3) 
```

## Read in Data {.smaller}

```{r plotEx, comment="",prompt=TRUE, fig.align='center',cache=TRUE}
...
```{r plot1, comment="",prompt=TRUE, fig.width=4,fig.height=4, fig.align='center',cache=TRUE}
...
```{r plotEx2, comment="",prompt=TRUE, fig.width=4,fig.height=4, fig.align='center',cache=TRUE}
plot(as.numeric(death["Sweden",])~year,
...
```{r plotEx3, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
plot(as.numeric(death["Sweden",])~year,
      ylab="# of deaths per family", main = "Sweden",
...
```{r plotEx4, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r plotEx6, comment="",prompt=TRUE, fig.width=8,fig.height=4,fig.align='center', cache=TRUE}
par(mfrow=c(1,2))
...
```{r barplot2, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
## Stacked Bar Charts
...
```{r barplot2a, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r barplot3, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r boxplots, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
...
```{r geoboxplot, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
library(ggplot2)
...
```{r geoboxpoint, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r hist, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
hist(ChickWeight$weight, breaks=20)
```

## Multiple Histograms {.smaller}

```{r ghist, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r ghist_alpha, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r gdens, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
qplot(x= weight, fill = Diet, data = ChickWeight, 
...
```{r gdens_alpha, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r gdens_line_alpha, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r spaghetti, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
...
```{r fac_spag, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
qplot(x=Time, y=weight, colour = Chick, 
      facets = ~ Diet, 
      data = ChickWeight, geom = "line")
```
...
```{r fac_spag_noleg, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
qplot(x=Time, y=weight, colour = Chick, 
      facets = ~ Diet, 
      data = ChickWeight, geom = "line") +  
          guides(colour=FALSE)
...
```{r pal, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
palette("default")
plot(1:8, 1:8, type="n")
...
```{r pal2, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
...
```{r pal3, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
palette("default")
...
```{r pal4, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
...
```{r pal5, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
library(RColorBrewer)
palette(brewer.pal(5,"Dark2"))
...
```{r leg1, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
palette(brewer.pal(5,"Dark2"))
plot(weight ~ jitter(Time,amount=0.2),
     data=ChickWeight,
     pch = 19,  col = Diet,xlab="Time")
...
```{r circ, comment="",prompt=TRUE, fig.width=4.5,fig.height=4.5,fig.align='center', cache=FALSE}
...
```{r circ2, comment="",prompt=TRUE, fig.width=4.5,fig.height=4.5,fig.align='center', cache=FALSE}
...
```{r lattice1, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
library(lattice)
...
```{r lattice2, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
densityplot(~weight | Diet, data = ChickWeight)
```

## Lattice

```{r levelplot1, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=FALSE}
...
```{r levelplot2, comment="",prompt=TRUE, fig.width=4,fig.height=4,fig.align='center', cache=TRUE}
library(RColorBrewer)
